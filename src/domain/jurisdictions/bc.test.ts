...
describe("BC newly-built-home exemption", () => {
  ...
  it("does not call an exact tie a supersession", () => {
    // An ordinary band, not a corner. At or below $500,000 both exemptions forgive the whole
    // property transfer tax on a new build bought by a first-time buyer: the newly-built one
